...
class StudyInfo(BaseModel):
    ...
    transplanting_date: Optional[str] = Field(None, description="移栽日期（ISO 8601 格式，如 2022-05-20）")
    heading_date: Optional[str] = Field(None, description="始穗-抽穗日期（ISO 8601 格式，如 2022-07-15）")
    full_heading_date: Optional[str] = Field(None, description="齐穗日期（ISO 8601 格式，如 2022-07-20）")
    maturity_date: Optional[str] = Field(None, description="成熟日期/生理成熟期（ISO 8601 格式，如 2022-09-10）")
